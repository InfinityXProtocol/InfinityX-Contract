...
//
// InfinityX Protocol COPYRIGHT (C) 2023
...
contract InfinityX is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("InfinityX", "INFX", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x052d6C44d3B7cF3894388A01E1067A1D4f5fddDe;
        TreasuryReceiver = 0xe9F7122C3431ac0175bd31b8A6Ad98534338a4a3;
        RiskFreeValueReceiver = 0xef482470631e6581E5C4fB92FCa3DfC5a6C70085;
